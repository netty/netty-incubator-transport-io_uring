...
public final class IOUringServerSocketChannelConfig extends DefaultChannelConfig implements ServerSocketChannelConfig {
    ...
    @Override
    public IOUringServerSocketChannelConfig setRecvBufferAllocator(RecvBufferAllocator allocator) {
     ...
     * {@link ServerSocketChannel}s to the same port and so accept connections with multiple
     * threads.
     *
     * Be aware this method needs be called before
     * {@link ServerSocketChannel#bind(java.net.SocketAddress)} to have any affect.
     */
