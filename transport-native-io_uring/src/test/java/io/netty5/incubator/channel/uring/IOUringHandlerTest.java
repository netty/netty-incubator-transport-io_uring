...
public class IOUringHandlerTest extends AbstractSingleThreadEventLoopTest {
    ...
    public void shutdownGracefullyZeroQuietBeforeStart() throws Exception {
        EventLoopGroup group = new MultithreadEventLoopGroup(2, newIoHandlerFactory());
    ...
    public void testSubmitMultipleTasksAndEnsureTheseAreExecuted() throws Exception {
        EventLoopGroup group = new MultithreadEventLoopGroup(2, IOUringHandler.newFactory());
        try {
