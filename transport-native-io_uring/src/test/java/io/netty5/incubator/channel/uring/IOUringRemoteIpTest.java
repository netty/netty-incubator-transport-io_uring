        ...
        try {
            ...
            if (server == null) {
                ...
                connectAddress = new InetSocketAddress(client,
                        ((InetSocketAddress) f.get().localAddress()).getPort());
            } else {
                try {
                ...
                connectAddress = (InetSocketAddress) f.get().localAddress();
            }
            ...
            InetSocketAddress addr = (InetSocketAddress) promise.getNow();
