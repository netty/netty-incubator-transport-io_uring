...
static jbyte netty5_io_uring_ioringOpWritev(JNIEnv* env, jclass clazz) {
    return IORING_OP_WRITEV;
}

static jbyte netty5_io_uring_ioringOpPollAdd(JNIEnv* env, jclass clazz) {
    return IORING_OP_POLL_ADD;
}

static jbyte netty5_io_uring_ioringOpPollRemove(JNIEnv* env, jclass clazz) {
    return IORING_OP_POLL_REMOVE;
}

static jbyte netty5_io_uring_ioringOpTimeout(JNIEnv* env, jclass clazz) {
    return IORING_OP_TIMEOUT;
}

static jbyte netty5_io_uring_ioringOpAccept(JNIEnv* env, jclass clazz) {
    return IORING_OP_ACCEPT;
}

static jbyte netty5_io_uring_ioringOpRead(JNIEnv* env, jclass clazz) {
    return IORING_OP_READ;
}

static jbyte netty5_io_uring_ioringOpWrite(JNIEnv* env, jclass clazz) {
    return IORING_OP_WRITE;
}

static jbyte netty5_io_uring_ioringOpConnect(JNIEnv* env, jclass clazz) {
    return IORING_OP_CONNECT;
}

static jbyte netty5_io_uring_ioringOpClose(JNIEnv* env, jclass clazz) {
    return IORING_OP_CLOSE;
}

static jbyte netty5_io_uring_ioringOpSendmsg(JNIEnv* env, jclass clazz) {
    return IORING_OP_SENDMSG;
}

static jbyte netty5_io_uring_ioringOpRecvmsg(JNIEnv* env, jclass clazz) {
...
static const JNINativeMethod statically_referenced_fixed_method_table[] = {
  ...
  { "ioringOpWritev", "()B", (void *) netty5_io_uring_ioringOpWritev },
  { "ioringOpPollAdd", "()B", (void *) netty5_io_uring_ioringOpPollAdd },
  { "ioringOpPollRemove", "()B", (void *) netty5_io_uring_ioringOpPollRemove },
  { "ioringOpTimeout", "()B", (void *) netty5_io_uring_ioringOpTimeout },
  { "ioringOpAccept", "()B", (void *) netty5_io_uring_ioringOpAccept },
  { "ioringOpRead", "()B", (void *) netty5_io_uring_ioringOpRead },
  { "ioringOpWrite", "()B", (void *) netty5_io_uring_ioringOpWrite },
  { "ioringOpConnect", "()B", (void *) netty5_io_uring_ioringOpConnect },
  { "ioringOpClose", "()B", (void *) netty5_io_uring_ioringOpClose },
  { "ioringOpSendmsg", "()B", (void *) netty5_io_uring_ioringOpSendmsg },
  { "ioringOpRecvmsg", "()B", (void *) netty5_io_uring_ioringOpRecvmsg },
