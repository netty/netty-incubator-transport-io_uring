...
public class IOUringDomainSocketSslClientRenegotiateTest extends SocketSslClientRenegotiateTest {

    public IOUringDomainSocketSslClientRenegotiateTest(SslContext serverCtx, SslContext clientCtx, boolean delegate) {
