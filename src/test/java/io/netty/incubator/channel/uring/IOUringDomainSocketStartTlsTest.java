...
public class IOUringDomainSocketStartTlsTest extends SocketStartTlsTest {

    public IOUringDomainSocketStartTlsTest(SslContext serverCtx, SslContext clientCtx) {
