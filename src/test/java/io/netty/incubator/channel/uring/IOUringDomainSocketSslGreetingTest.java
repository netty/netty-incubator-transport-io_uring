...
public class IOUringDomainSocketSslGreetingTest extends SocketSslGreetingTest {

    public IOUringDomainSocketSslGreetingTest(SslContext serverCtx, SslContext clientCtx, boolean delegate) {
